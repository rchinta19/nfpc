...
const Renderdefectlog = (props) => {
  ...
  return (
    <tr>
      ...
      <td className="tdf"><div><button type="button" onClick={handleOpen}><img src={PF+props.dlitm.Image}  alt="" style={{cursor:"pointer"}}/></button><StyledModal
      ...
      <td className="tdf"><input type="checkbox" id="topping" name="topping" style={{cursor:"pointer"}} value={props.dlitm.Mark_False_Positive} onChange={()=>{props.selectHandler(props.dlitm.Mark_False_Positive,props.dlitm.Sl_No)}} checked={props.checkValue==0?false:true} /></td>
    </tr>
  );
};
