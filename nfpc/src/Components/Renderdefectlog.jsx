...
const Renderdefectlog = (props) => {
  ...
  return (
    <tr>
      ...
      <td className="tdf">{props.hditm.Mark_False_Positive}<input type="checkbox" id="topping" name="topping" 
      value={props.hditm.Mark_False_Positive}
       onChange={()=>{props.selectHandler(props.hditm.Mark_False_Positive,props.hditm.Sl_No)}} 
       checked={props.checkValue==0?false:true} /></td>
    </tr>
  );
};
