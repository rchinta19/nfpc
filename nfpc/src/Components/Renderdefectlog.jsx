...
const Renderdefectlog = (props) => {
  ...
  return (
    <tr>
      ...
      <td className="tdf"><input type="checkbox" id="topping" name="topping" value={props.dlitm.Mark_False_Positive} onChange={()=>{props.selectHandler(props.hditm.Mark_False_Positive,props.hditm.Sl_No)}} checked={props.checkValue==0?false:true} /></td>
    </tr>
  );
};
